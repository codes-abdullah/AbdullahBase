 ...
 */
public interface CodepointSupportPairsReindexer {

	CodepointSupportPairsReindexer REINDEX = new ReindexSurrogatePair();
	CodepointSupportPairsReindexer IQNORE = new IgnoreSurrogatePair();

	/**
	 * {@link CodepointSupport#reindex(char[], int, int)} will always re-index
	 * if supported, this method does rely on {@link CodepointSupportPairsReindexer}
	...
	public static class IgnoreSurrogatePair implements CodepointSupportPairsReindexer {
	...
	public static class ReindexSurrogatePair implements CodepointSupportPairsReindexer {
