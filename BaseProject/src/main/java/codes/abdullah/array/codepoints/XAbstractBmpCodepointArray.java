...
abstract class XAbstractBmpCodepointArray implements XCodepointArray {
	...
	public int compareTo(XCodepointArray o) {
		XCharArray oarr;
		if (o instanceof XAbstractBmpCodepointArray)
			oarr = ((XAbstractBmpCodepointArray) o).unsafe();
		else if (o instanceof XAbstractSupplementaryCodepointArray)
			oarr = ((XAbstractSupplementaryCodepointArray) o).unsafe();
		else
			oarr = o.getArray();
		return unsafe().compareTo(oarr);
	}

	@Override
	public int hashCode() {
		return Lang.hashCode.of(unsafe().getArray(), length());
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof XCodepointArray) {
			XAbstractBmpCodepointArray o = (XAbstractBmpCodepointArray) obj;
