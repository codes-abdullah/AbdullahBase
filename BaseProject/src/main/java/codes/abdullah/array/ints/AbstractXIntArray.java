...
public abstract class AbstractXIntArray implements XIntArray {
	...
	@Override
	public XIntArray ensureCapacity(int required) {
		int[] arr = getArray();
		int len = length();
	...
	@Override
	public XIntArray expand(int index, int size) {
		int[] arr = getArray();
		int len = length();
	...
	@Override
	public XIntArray reverse(int from, int to) {
		int[] arr = getArray();
		int len = length();
	...
	@Override
	public XIntArray shuffle(int from, int to) {
		int[] arr = getArray();
		int len = length();
	...
	@Override
	public XIntArray shrink(int index, int size) {
		int[] arr = getArray();
		int len = length();
	...
	@Override
	public XIntArray displace(int displacement, int from, int to) {
		int[] arr = getArray();
		int len = length();
	...
	@Override
	public XIntArray swap(int left, int right) {
		int[] arr = getArray();
		int len = length();
	...
	@Override
	public XIntArray fill(int value, int from, int to) {
		int[] arr = getArray();
		int len = length();
	...
	@Override
	public int compareTo(XIntArray o) {
		int[] oarr = o instanceof AbstractXIntArray ? ((AbstractXIntArray) o).unsafe() : o.getArray();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		if (!(obj instanceof AbstractXIntArray))
			return false;
		AbstractXIntArray oarr = (AbstractXIntArray) obj;
