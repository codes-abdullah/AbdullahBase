...
public class JavaDoubleConsts {
	/**
	 * Don't let anyone instantiate this class.
	 */
	private JavaDoubleConsts() {
	}
	 ...
	 * <code>double</code>, 2<sup>-1022</sup>. It is equal to the value returned by
	...
	/**
	 * Maximum exponent a finite <code>double</code> number may have. It is equal to
	 * the value returned by <code>Math.ilogb(Double.MAX_VALUE)</code>.
	 */
	...
	/**
	 * The exponent the smallest positive <code>double</code> subnormal value would
	...
	static {
		...
		assert (((SIGN_BIT_MASK | EXP_BIT_MASK | SIGNIF_BIT_MASK) == ~0L) && (((SIGN_BIT_MASK & EXP_BIT_MASK) == 0L)
				&& ((SIGN_BIT_MASK & SIGNIF_BIT_MASK) == 0L) && ((EXP_BIT_MASK & SIGNIF_BIT_MASK) == 0L)));
	}
}
