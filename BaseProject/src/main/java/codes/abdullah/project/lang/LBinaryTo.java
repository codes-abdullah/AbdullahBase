...
public class LBinaryTo {
	...
	/**
	 * @see #ints(long, int[], int, boolean)
	 */
	public byte[] bytes(short n, byte[] out, int outlen, boolean skipZeros) {
		if (n == 0) {
			return out;
		}
		...
		int index = 0;
		out = out == null ? new byte[wordsInUse] : Lang.capacity.ensure(out, outlen, wordsInUse, true);
	 ...
	 * @see #ints(long, int[], int, boolean)
	 */
	public byte[] bytes(int n, byte[] out, int outlen, boolean skipZeros) {
		if (n == 0) {
			return out;
		}
	 ...
	 * @see #ints(long, int[], int, boolean)
	 */
	public byte[] bytes(long n, byte[] out, int outlen, boolean skipZeros) {
		if (n == 0) {
			return out;
		}
	...
	/**
	 * @see #longs(int[], int, int, int, long[], int)
	 */
	public byte[] bytes(short[] in, int inlen, int from, int to, byte[] out, int outlen) {
		...
		out = out == null ? new byte[count] : Lang.capacity.ensure(out, outlen, count, true);
		...
		for (short x = in[to - 1]; x != 0; x = (short) ((_in_mask & x) >>> _out_size)) {
			atOut = outindex++;
	...
	public byte[] bytes(char[] in, int inlen, int from, int to, byte[] out, int outlen) {
		...
		for (char x = in[to - 1]; x != 0; x = (char) ((_in_mask & x) >>> _out_size)) {
			atOut = outindex++;
			out[atOut] = (byte) (x & _out_mask);
		}
		return out;
	...
	public byte[] bytes(int[] in, int inlen, int from, int to, byte[] out, int outlen) {
		...
		for (int x = in[to - 1]; x != 0; x = (int) ((_in_mask & x) >>> _out_size)) {
			atOut = outindex++;
			out[atOut] = (byte) (x & _out_mask);
		}
		return out;
	...
	public byte[] bytes(long[] in, int inlen, int from, int to, byte[] out, int outlen) {
		...
		for (long x = in[to - 1]; x != 0; x = (long) ((_in_mask & x) >>> _out_size)) {
			atOut = outindex++;
			out[atOut] = (byte) (x & _out_mask);
		}
		return out;
	 ...
	 * @see #ints(long, int[], int, boolean)
	 */
	public short[] shorts(int n, short[] out, int outlen, boolean skipZeros) {
		if (n == 0) {
			return out;
		}
		...
		int index = 0;
		out = out == null ? new short[wordsInUse] : Lang.capacity.ensure(out, outlen, wordsInUse, true);
		for (int j = 0; j < wordsInUse; j++) {
			out[index++] = (short) n;
			n >>>= Short.SIZE;
		}
	 ...
	 * @see #ints(long, int[], int, boolean)
	 */
	public short[] shorts(long n, short[] out, int outlen, boolean skipZeros) {
		if (n == 0) {
			return out;
		}
	...
	public short[] shorts(byte[] in, int inlen, int from, int to, short[] out, int outlen) {
		...
		out = out == null ? new short[arr_out_len] : Lang.capacity.ensure(out, outlen, arr_out_len, true);
		short tmp = 0;
		for (int i = 0; i < arr_out_len; i++) {
			tmp = (short) (in[from++] & mask);
			for (int j = 1; j < parts && from < to; j++) {
				tmp |= (((short) (in[from++] & mask)) << _in_size * j);
			}
			out[i] |= tmp;
		}
		return out;
	...
	public short[] shorts(char[] in, int inlen, int from, int to, short[] out, int outlen) {
		inlen = to - from;
		out = out == null ? new short[inlen] : Lang.capacity.ensure(out, outlen, inlen, true);
	...
	public short[] shorts(int[] in, int inlen, int from, int to, short[] out, int outlen) {
		...
		inlen = to - from;
		int count = _outputs_per_input * inlen;
		out = out == null ? new short[count] : Lang.capacity.ensure(out, outlen, count, true);
		int outindex = 0, atOut, atIn;
		int tmp = 0;
		for (; from < to - 1; from++) {
			atIn = from;
	...
	public char[] chars(byte[] in, int inlen, int from, int to, char[] out, int outlen) {
		...
		final int arr_out_len = (inlen + (parts - 1)) / parts;
		final short mask = (1 << _in_size) - 1;
		out = out == null ? new char[arr_out_len] : Lang.capacity.ensure(out, outlen, arr_out_len, true);
		char tmp = 0;
		for (int i = 0; i < arr_out_len; i++) {
			tmp = (char) (in[from++] & mask);
			for (int j = 1; j < parts && from < to; j++) {
				tmp |= (((char) (in[from++] & mask)) << _in_size * j);
			}
			out[i] |= tmp;
		}
		return out;
	...
	public char[] chars(short[] in, int inlen, int from, int to, char[] out, int outlen) {
		inlen = to - from;
		out = out == null ? new char[inlen] : Lang.capacity.ensure(out, outlen, inlen, true);
		for (int i = 0; from < to; from++, i++) {
			out[i] = (char) in[from];
		}
		return out;
	...
	public char[] chars(int[] in, int inlen, int from, int to, char[] out, int outlen) {
		...
		out = out == null ? new char[count] : Lang.capacity.ensure(out, outlen, count, true);
		int outindex = 0, atOut, atIn;
	...
	public int[] ints(long n, int[] out, int outlen, boolean skipZeros) {
		...
		int index = 0;
		out = out == null ? new int[wordsInUse] : Lang.capacity.ensure(out, outlen, wordsInUse, true);
		for (int j = 0; j < wordsInUse; j++) {
			out[index++] = (int) n;
			n >>>= Integer.SIZE;
		}
	...
	public int[] ints(byte[] in, int inlen, int from, int to, int[] out, int outlen) {
		...
		out = out == null ? new int[arr_out_len] : Lang.capacity.ensure(out, outlen, arr_out_len, true);
		int tmp = 0;
		for (int i = 0; i < arr_out_len; i++) {
			tmp = (int) (in[from++] & mask);
			for (int j = 1; j < parts && from < to; j++) {
				tmp |= (((int) (in[from++] & mask)) << _in_size * j);
			}
			out[i] |= tmp;
		}
		return out;
	...
	public int[] ints(long[] in, int inlen, int from, int to, int[] out, int outlen) {
		...
		inlen = to - from;
		int count = _outputs_per_input * inlen;
		out = out == null ? new int[count] : Lang.capacity.ensure(out, outlen, count, true);
		int outindex = 0, atOut, atIn;
		long tmp = 0;
		for (; from < to - 1; from++) {
			atIn = from;
	...
	public long[] longs(byte[] in, int inlen, int from, int to, long[] out, int outlen) {
		...
		out = out == null ? new long[arr_out_len] : Lang.capacity.ensure(out, outlen, arr_out_len, true);
		long tmp = 0;
		for (int i = 0; i < arr_out_len; i++) {
			tmp = (long) (in[from++] & mask);
			for (int j = 1; j < parts && from < to; j++) {
				tmp |= (((long) (in[from++] & mask)) << _in_size * j);
			}
			out[i] |= tmp;
		}
		return out;
