 ...
 * surrogates<br>
 */
public interface CodepointSupport {
	/**
	 * Invoker must take care of all checks such as ranges, valid code-points and
	 * null pointers<br>
	 * <br>
	 ...
	 */
	public static final CodepointSupport BMP = new CodepointSupportBmpImpl();
	/**
	 * Invoker must take care of all checks such as ranges, valid code-points and
	 * null pointers<br>
	 * <br>
	 ...
	 */
	public static final CodepointSupport SUPPORTED = new CodepointSupportSupplementaryImpl();
	/**
	 * Invoker must take care of all checks such as ranges, valid code-points and
	 * null pointers<br>
	 * <br>
	 ...
	 */
	public static final CodepointSupport DEBUG = new CodepointSupportSupplementaryDebugImpl();
	 ...
	 * to(index)<br>
	 */
	int reindex(char[] arr, int len, int index);
	 ...
	 * 
	 */
	int[] reindex(char[] arr, int len, int[] indexes);
	 ...
	 */
	boolean isBmp(char[] arr, int len, int index);
	 ...
	 * {@link CodepointSupportSupplementaryDebugImpl#cps}<br>
	 */
	 ...
	 */
	boolean isPair(char[] arr, int len, int index);
	 ...
	 * arr[index-1] is low<br>
	 */
	boolean isPairBackwardly(char[] arr, int len, int index);
	 ...
	 * low<br>
	 */
	boolean isHighOrLow(char[] arr, int len, int index);
	 ...
	 * - {@link #DEBUG}: true if high in range 'A'-'Z'<br>
	 */
	boolean isHigh(char[] arr, int len, int index);
	 ...
	 * - {@link #DEBUG}: true if low in range '0'-'9'<br>
	 */
	boolean isLow(char[] arr, int len, int index);
	 ...
	 * arr[index] is low<br>
	 */
	boolean isPairIntersectly(char[] arr, int len, int index);
	 ...
	 */
	int getCodepoint(char[] arr, int len, int index);
	 ...
	 */
	int getCodepointBackwardly(char[] arr, int len, int index);
	 ...
	 * @see #toHigh(int)
	 */
	char toHigh(char[] arr, int len, int index);

	/**
	 * @see #toLow(int)
	 */
	char toLow(char[] arr, int len, int index);
	 ...
	 * code-point based on implementation<br>
	 */
	int toCodepoint(char[] arr, int len, int index);
	 ...
	 * 
	 * */
	int toCodepointBackwardly(char[] arr, int len, int index);
	 ...
	 * 
	 * */
	int toCodepointIntersectly(char[] arr, int len, int index);
	 ...
	 * {@link #toCodepointArray(char[], int, int, int)}
	 */
	int[] toCodepointArray(char[] arr, int len);

	/**
	 * {@link #toCodepointArray(char[], int, int, int)}
	 */
	int[] toCodepointArray(char[] arr, int len, int from);
	 ...
	 * given range<br>
	 */
	int[] toCodepointArray(char[] arr, int len, int from, int to);
	 ...
	 * given cp<br>
	 */
	char[] toCharArray(int cp);

	/**
	 * @see #toCharArray(int[], int, int, int, char[], int)
	 */
	char[] toCharArray(int[] arr, int len);

	/**
	 * @see #toCharArray(int[], int, int, int, char[], int)
	 */
	char[] toCharArray(int[] arr, int len, int from);

	/**
	 * @see #toCharArray(int[], int, int, int, char[], int)
	 */
	char[] toCharArray(int[] arr, int len, int from, int to);

	/**
	 * @see #toCharArray(int[], int, int, int, char[], int)
	 */
	char[] toCharArray(int[] arr, int len, int from, int to, char[] out);
	 ...
	 */
	char[] toCharArray(int[] arr, int len, int from, int to, char[] out, int outlen);
	 ...
	 * the char-array length, the output array always trimmed to length<br>
	 */
	int toCharArray(int cp, char[] out, int outlen, int insertAt);
	 ...
	 */
	int countCodepoints(char[] arr, int len);

	/**
	 * @see #countCodepoints(char[], int, int, int)
	 */
	int countCodepoints(char[] arr, int len, int from);
	 ...
	 */
	int countCodepoints(char[] arr, int len, int from, int to);
	 ...
	 */
	int extendablePairsCount(char[] arr, int len);

	/**
	 * @see #extendablePairsCount(char[], int, int, int)
	 */
	int extendablePairsCount(char[] arr, int len, int from);
	 ...
	 * </pre>
	 */
	int extendablePairsCount(char[] arr, int len, int from, int to);
	 ...
	 */
	int fixedPairsCount(char[] arr, int len);

	/**
	 * @see #fixedPairsCount(char[], int, int, int)
	 */
	int fixedPairsCount(char[] arr, int len, int from);

	/**
	 * @see #fixedPairsCount(char[], int, int, int)
	 */
	int fixedPairsCount(char[] arr, int len, int from, int to);
	 ...
	 * @see #lengthOf(int)
	 */
	int lengthOf(char[] arr, int len, int index);
	 ...
	 * better to use {@link LColumn#from(char[], int, int, int, CodepointSupport)}
	 * <br>
	 ...
	 * @see #lengthOf(int)
	 */
	int lengthOfBackwardly(char[] arr, int len, int index);
	 ...
	 * @see #lengthOf(int)
	 */
	int lengthOfIntersectly(char[] arr, int len, int index);
	 ...
	 */
	int indexOfBroken(char[] arr, int len);

	/**
	 * 
	 * @see #indexOfBroken(char[], int, int, int)
	 */
	int indexOfBroken(char[] arr, int len, int from);
	 ...
	 */
	int indexOfBroken(char[] arr, int len, int from, int to);
	 ...
	 */
	boolean equals(char[] arr, int len, int index, int cp);
	 ...
	 * otherHigh and arr[index+1] == otherLow
	 */
	boolean equals(char[] arr, int len, int index, int cp, boolean ignoreCase);
	 ...
	 */
	boolean equals(char[] arr, int len, int index, char otherHigh, char otherLow);
	 ...
	 * otherHigh and arr[index+1] == otherLow
	 */
	boolean equals(char[] arr, int len, int index, char otherHigh, char otherLow, boolean ignoreCase);
	 ...
	 */
	boolean equalsIntersectly(char[] arr, int len, int index, int cp);
	 ...
	 */
	boolean equalsIntersectly(char[] arr, int len, int index, int cp, boolean ignoreCase);
	 ...
	 */
	boolean equalsIntersectly(char[] arr, int len, int index, char otherHigh, char otherLow);
	 ...
	 * otherHigh and arr[index] == otherLow
	 */
	boolean equalsIntersectly(char[] arr, int len, int index, char otherHigh, char otherLow, boolean ignoreCase);
	 ...
	 */
	boolean equalsBackwardly(char[] arr, int len, int index, int cp);
	 ...
	 * otherHigh and arr[index-1] == otherLow
	 */
	boolean equalsBackwardly(char[] arr, int len, int index, int cp, boolean ignoreCase);

	// --------------
	/**
	 * @see #equalsBackwardly(char[], int, int, char, char, boolean)
	 */
	boolean equalsBackwardly(char[] arr, int len, int index, char otherHigh, char otherLow);
	 ...
	 * otherHigh and arr[index-1] == otherLow
	 */
	boolean equalsBackwardly(char[] arr, int len, int index, char otherHigh, char otherLow, boolean ignoreCase);
