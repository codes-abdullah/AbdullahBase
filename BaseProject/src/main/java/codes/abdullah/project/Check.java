...
public class Check {
	...
	/**
	 * @throws IllegalArgumentException
	 * @see {@link #bmpAndGet(int, CodepointSupport)}
	 */
	public static int bmp(int cp) throws IllegalArgumentException {
		return bmp(cp, CodepointSupport.BMP);
	}
	 ...
	 * @see {@link #bmpAndGet(int, CodepointSupport)}
	 */
	public static int bmp(int cp, CodepointSupport cps) throws IllegalArgumentException {
		IllegalArgumentException e = bmpAndGet(cp, cps);
		if (e != null)
			throw e;
		return cp;
	}
	 ...
	 * @return cp
	 */
	public static int codePoint(int cp) throws IllegalArgumentException {
		return codePoint(cp, CodepointSupport.SUPPORTED);
	}

	/**
	 * @throws IllegalArgumentException
	 * @see {@link #codePointAndGet(int, CodepointSupport)}
	 */
	public static int codePoint(int cp, CodepointSupport cps) throws IllegalArgumentException {
		IllegalArgumentException e = codePointAndGet(cp, cps);
		if (e != null)
			throw e;
		return cp;
	}
	...
	/**
	 * @see #bmpAndGet(int, CodepointSupport)
	 */
	public static IllegalArgumentException bmpAndGet(int cp) {
		return bmpAndGet(cp, CodepointSupport.BMP);
	}

	/**
	 * return {@link IllegalArgumentException} if cp is not valid according to
	 * {@link CodepointSupport#isBmp(int)}
	 */
	public static IllegalArgumentException bmpAndGet(int cp, CodepointSupport cps) {
		if (!cps.isBmp(cp)) {
			return new IllegalArgumentException(String.format("not valid BMP, found: %s", cp));
		}
		return null;
	}

	/**
	 * @see #codePointAndGet(int, CodepointSupport)
	 */
	public static IllegalArgumentException codePointAndGet(int cp) {
		return codePointAndGet(cp, CodepointSupport.SUPPORTED);
	}

	/**
	 * return {@link IllegalArgumentException} if cp is not valid according to
	 * {@link CodepointSupport#isValid(int)}
	 */
	public static IllegalArgumentException codePointAndGet(int cp, CodepointSupport cps) {
		if (!cps.isValid(cp)) {
	...
	public static IllegalArgumentException lengthAndGet(int length, int min) {
		return lengthAndGet(length, min, Lang.constant.ARRAY_SAFE_CAPACITY);
	}
	 ...
	 */
	public static Object nulled(Object o) throws NullPointerException {
	 ...
	 */
	public static Object nulled(Object o, CharSequence msg) throws NullPointerException {
