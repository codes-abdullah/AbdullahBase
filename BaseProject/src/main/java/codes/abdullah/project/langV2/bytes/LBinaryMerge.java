...
public class LBinaryMerge {
	...
	public byte[] bytes(byte[] in, int inlen, short[] with, int withlen) {
		byte[] with2 = Lang.binary.to.bytes(with, withlen, 0, withlen, null, 0);
	...
	public short[] shorts(short[] in, int inlen, byte[] with, int withlen) {
		short[] with2 = Lang.binary.to.shorts(with, withlen, 0, withlen, null, 0);
	...
	public char[] chars(char[] in, int inlen, byte[] with, int withlen) {
		char[] with2 = Lang.binary.to.chars(with, withlen, 0, withlen, null, 0);
	...
	public int[] ints(int[] in, int inlen, byte[] with, int withlen) {
		int[] with2 = Lang.binary.to.ints(with, withlen, 0, withlen, null, 0);
	...
	public long[] longs(long[] in, int inlen, byte[] with, int withlen) {
		long[] with2 = Lang.binary.to.longs(with, withlen, 0, withlen, null, 0);
	...
	/**
	 * Merge given arrays together in binary base, see {@link LBinaryTo}
	 * 
	 * <br>
	 ...
	 * @return new allocated array with both arrays based on {@link LBinaryTo}
	 */
	...
	public static class E {
		...
		public byte[] bytes(byte[] in, int inlen, short[] with, int withlen, Endian read, Endian write) {
			byte[] with2 = Lang.binary.to.e.bytes(with, withlen, 0, withlen, read, null, 0, read);
		...
		public short[] shorts(short[] in, int inlen, byte[] with, int withlen, Endian read, Endian write) {
			short[] with2 = Lang.binary.to.e.shorts(with, withlen, 0, withlen, read, null, 0, read);
		...
		public char[] chars(char[] in, int inlen, byte[] with, int withlen, Endian read, Endian write) {
			char[] with2 = Lang.binary.to.e.chars(with, withlen, 0, withlen, read, null, 0, read);
		...
		public int[] ints(int[] in, int inlen, byte[] with, int withlen, Endian read, Endian write) {
			int[] with2 = Lang.binary.to.e.ints(with, withlen, 0, withlen, read, null, 0, read);
		...
		public long[] longs(long[] in, int inlen, byte[] with, int withlen, Endian read, Endian write) {
			long[] with2 = Lang.binary.to.e.longs(with, withlen, 0, withlen, read, null, 0, read);
